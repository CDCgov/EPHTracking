...
/*   Scripts/CO_ED_Validation.sas                    */
/* STEP 2 OLEDB import replaced by sample Validation  */
/* data built in autoexec.sas; macros and ODS PDF    */
/* target set to local values. Validation logic       */
...
%let StateName = Colorado; /*include your jurisdiction ex. Arizona*/
...
/**** STEP 2. Import the data — see autoexec.sas (Validation dataset) ****/
...
proc tabulate data=Validation;
	...
	table EDVisitYear*County, IncidentCountFire IncidentCountNonFire IncidentCountUnknown MonthlyVisits;
run;

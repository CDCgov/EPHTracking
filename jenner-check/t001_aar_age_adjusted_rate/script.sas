...
/*                                                                             */
/* Source: Tracking Data Methods/AAR Example SAS Code.sas                      */
/* The OLEDB import (STEP 1) has been replaced by sample Count_Data and        */
/* Population_Data built in autoexec.sas; STEPs 2-7 are unchanged.             */
/*=============================================================================*/

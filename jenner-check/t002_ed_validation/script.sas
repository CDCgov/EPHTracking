...
/*   Scripts/ED_Validation.sas                       */
/* STEP 2 OLEDB import replaced by sample Validation  */
/* data built in autoexec.sas; the ODS PDF target and */
/* StateName macro are set to local values so the     */
/* output writes alongside the run. The 14 validation */
/* checks (STEPs 4-7) are unchanged from source.      */
/*===================================================*/
...
%let StateName = Arizona; /*include your jurisdiction ex. Arizona*/
